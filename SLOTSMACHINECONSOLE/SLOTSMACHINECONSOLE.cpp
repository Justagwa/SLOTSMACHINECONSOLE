...
void win(vector<int> num) {
    ...
    cout << "   .----------------.  .----------------.  .-----------------. .-----------------.\n"
        ...
        "  | |  | |/  \\| |  | || |      | |     | || |  | |\\ \\| |   | || |  | |\\ \\| |   | |\n"
        "  | |  |   /\\   |  | || |     _| |_    | || | _| |_\\   |_  | || | _| |_\\   |_  | |\n"
        "  | |  |__/  \\__|  | || |    |_____|   | || ||_____||\\___| | || ||_____||\\___| | |\n"
        "  | |              | || |              | || |              | || |              | |\n"
        "  | '--------------' || '--------------' || '--------------' || '--------------' |\n"
        "   '----------------'  '----------------'  '----------------'  '----------------' ";
    ...
    cout << "   .----------------.  .----------------.  .-----------------. .-----------------. .----------------. \n"
        "  | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |\n"
        "  | | _____  _____ | || |     _____    | || | ____  _____  | || | ____  _____  | || |  _________   | |\n"
        "  | ||_   _||_   _|| || |    |_   _|   | || ||_   \\|_   _| | || ||_   \\|_   _| | || | |_   ___  |  | |\n"
        "  | |  | | /\\ | |  | || |      | |     | || |  |   \\ | |   | || |  |   \\ | |   | || |   | |_  \\_|  | |\n"
        "  | |  | |/  \\| |  | || |      | |     | || |  | |\\ \\| |   | || |  | |\\ \\| |   | || |   |  _|  _   | |\n"
        "  | |  |   /\\   |  | || |     _| |_    | || | _| |_\\   |_  | || | _| |_\\   |_  | || |  _| |___/ |  | |\n"
        "  | |  |__/  \\__|  | || |    |_____|   | || ||_____||\\___| | || ||_____||\\___| | || | |_________|  | |\n"
        "  | |              | || |              | || |              | || |              | || |              | |\n"
        "  | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |\n"
        "   '----------------'  '----------------'  '----------------'  '----------------'  '----------------' ";
    ...
    cout << "   .----------------.  .----------------.  .-----------------. .-----------------. .----------------.  .----------------. \n"
        ...
        "  | |  |__/  \\__|  | || |    |_____|   | || ||_____||\\___| | || ||_____||\\___| | || | |_________|  | || | |____| |___| | |\n"
        "  | |              | || |              | || |              | || |              | || |              | || |              | |\n"
        "  | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |\n"
        "   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' ";
...
int generate() {
    ...
    //THESE  DAMN NUMBERS ARENT RANDOM AT ALL FIX FIX FIX IFX PLS 5 5 2 2nd time 1 1 5
    srand(time(0));
...
void rollNumbers(vector<int>& sum, int initialDelay) {
    ...
    for (int j = 0; j < 3; j++) {
        ...
        for (int i = 0; i < 56; i++) {
            ...
            // Gradually increase delay for the next number
            if (delays[j] > 0)
                delays[j] += initialDelay * i / speed / 20;
            else
                break; // If the delay is already zero, stop updating this number
        }
        sum[j] = sumold;
        system("CLS");
        prin(sum);
